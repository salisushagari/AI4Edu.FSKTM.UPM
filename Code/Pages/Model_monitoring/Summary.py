...
def show():
    ...
    data = load_data(f"Code/{selected_semester}")
    ...
    if data is not None:
        ...
        st.image(f"Code/Pages/Model_monitoring/Display_Image/{selected_semester}.png", use_container_width=True)

        st.write("<span style='color: green;'>**Courses with Accuracy above and equal >=60:**</span>",
                 unsafe_allow_html=True,
                 style={'font-size': '18px'})
        course_above_data = load_data(f"Code/Pages/Model_monitoring/Display_Data/{selected_semester}_Courseabove")
        ...
        st.write("<span style='color: red;'>**Courses with Accuracy below than <60:**</span>",
                 unsafe_allow_html=True,
                 style={'font-size': '18px'})
        course_below_data_original = load_data(f"Code/Pages/Model_monitoring/Display_Data/{selected_semester}_Coursebelow")
        st.dataframe(course_below_data_original)

        course_below_data = load_data(f"Code/Pages/Model_monitoring/Display_Data/{selected_semester}", suffix='_Coursebelow')
        ...
        if feature_importance_type == "Global SHAP Values (Bar Plot)":
            ...
            """)
            st.image(f"Code/Pages/Model_monitoring/SHAP_Visualization/SHAPBAR{semester_suffix}.png", caption="SHAP Interpretability")
            ...
            """)
            st.image(f"Code/Pages/Model_monitoring/SHAP_Visualization/SHAPBee{semester_suffix}.png", caption="SHAP Interpretability")
            ...
            """)
            st.image(f"Code/Pages/Model_monitoring/SHAP_Visualization/SHAPWater{semester_suffix}.png", caption="SHAP Interpretability")
            ...
            """)
            st.image(f"Code/Pages/Model_monitoring/SHAP_Visualization/SHAPForce{semester_suffix}.png", caption="SHAP Interpretability")
            ...
            """)
            html_content = open(f"Code/Pages/Model_monitoring/SHAP_Visualization/SHAPSTACK{semester_suffix}.html", 'r').read()
        ...
        if feature_importance_type == "LIME Feature Importance":
           ...
           st.image(f"Code/Pages/Model_monitoring/LIME_Visualization/LIMEBAR{semester_suffix}.png", caption="LIME Local Explanation for Course ANALITIK BISNES")
