...
def show():
    ...
    if selected_course == "AGEN KOMPUTERAN":
        ...
        with col2:
            if st.checkbox("**Verification Analysis:** ", value=False):
                st.image("PredictVSActual2020.png", use_column_width=True)

        # Display the content of "AGEN KOMPUTERAN.csv"
        file_path = 'AGEN KOMPUTERAN.csv'
    ...
    file_path = filename_mappings.get(selected_matric_no)
